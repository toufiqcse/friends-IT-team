                ...
                <div className="bg-[#182233]  py-3 px-[5%] md:px-[10%]">
                    ...
                    <div
                        ...
                        <div className="">
                            ...
                            <p className="font-thin text-xl text-slate-400 font-[Rubik] text-justify">At Friends IT Solution, we are your trusted partner for comprehensive web solutions. Our team of experts specializes in frontend web development, ensuring that your online presence is not just visually appealing but also highly functional. We craft websites that leave a lasting impression.</p>
                        </div>
                    </div>
                    <div
                    ...
                    <div
                        ...
                        <div className="">
                            ...
                            <p className="font-thin text-xl font-[Rubik] text-justify text-slate-400">Harness the power of data with our web analysts. We dive deep into the numbers to provide actionable insights, helping you make informed decisions that lead to growth and success.</p>
                        </div>
                        <Image
                    ...
                    <div
                        ...
                        <div className="">
                            ...
                            <p className="font-thin text-xl font-[Rubik] text-justify text-slate-400">Our digital marketing experts are here to supercharge your online reach. We will help you navigate the ever-evolving landscape of SEO, social media, and paid advertising, driving targeted traffic and boosting your brands visibility.</p>
                        </div>
                    </div>
                    <div className="divider my-2 md:hidden"></div>
                    {/* SEO */}
